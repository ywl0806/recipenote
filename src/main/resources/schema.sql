...
create table recipe (id bigint generated by default as identity, created_at timestamp, updated_at timestamp, affiliate_id bigint,is_public boolean not null, content varchar(1000) not null, name varchar(255) not null, store_id bigint, user_id bigint not null, primary key (id));
...
create table user (user_id bigint generated by default as identity, created_at timestamp, updated_at timestamp, affiliate_id bigint, enabled boolean not null, name varchar(255) not null, password varchar(255) not null, username varchar(255) not null, primary key (user_id));
